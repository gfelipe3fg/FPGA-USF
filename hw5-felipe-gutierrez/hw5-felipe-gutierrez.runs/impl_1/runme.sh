...
HD_PWD='C:/Xilinx/Vivado/Projects/hw5-felipe-gutierrez/hw5-felipe-gutierrez.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lock_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lock_top.tcl -notrace
