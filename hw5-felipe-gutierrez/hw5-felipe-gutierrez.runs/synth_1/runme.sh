...
HD_PWD='C:/Xilinx/Vivado/Projects/hw5-felipe-gutierrez/hw5-felipe-gutierrez.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lock_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lock_top.tcl
